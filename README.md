...
Outro detalhe é que a face traseira de alguns triângulos que representam as folhas aparecem de frente para a câmera resultando em uma tonalidades de vermelho como é esperado pelo shader utilizado. Como esse shader é o mesmo de outros objetos da cena e seria desnecessário criar um novo apenas para renderizar um objeto, isso foi corrigido renderizando o .obj das folhas duas vezes alternando a orientação (lado da frente) dos triângulos e descartando as traseiras com CULL FACE. 
